...
if __name__ == "__main__":
    ...
    root.geometry(f"800x700+{w//2 - 200}+{h//2 - 200}")
    ...
    ax4.grid(which='major',
             color='k',
             linewidth=0.1)
    ax1.set_ylabel("y",labelpad=1,loc='bottom', fontsize=3)
    ax1.set_xlabel("x",labelpad=1,loc = 'left', fontsize=3)
    ax2.set_ylabel("y",labelpad=1,loc='bottom', fontsize=3)
    ax2.set_xlabel("x",labelpad=1,loc = 'left', fontsize=3)
    ax3.set_ylabel("y",labelpad=1,loc='bottom', fontsize=3)
    ax3.set_xlabel("x",labelpad=1,loc = 'left', fontsize=3)
    ax4.set_ylabel("y",labelpad=1,loc='bottom', fontsize=3)
    ax4.set_xlabel("x",labelpad=1,loc = 'left', fontsize=3)
